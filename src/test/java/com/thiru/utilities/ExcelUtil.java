...
public ExcelUtil(String path) {
	 ...
	 * IOException{
	 * 
	 * //System.out.println(filename); ExcelUtil datatable = null;
	 * 
	 * 
	 * datatable = new ExcelUtil(System.getProperty("user.dir")+
	 * "\\src\\test\\resources\\excel\\Testdata.xls"); for(int col=0 ;col<
	 * datatable.getColumnCount("AddCustomerTest"); col++){
